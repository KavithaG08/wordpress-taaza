...
if( !class_exists( 'TaazaPlusSiteLoaderOne' ) ) {
    class TaazaPlusSiteLoaderOne {
        ...
        function add_option( $options ) {
            $options['loader-1'] = esc_html__('Loader 1', 'taaza-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', TAAZA_PLUS_DIR_URL . 'modules/site-loader/layouts/loader-1/assets/css/loader-1.css', false, TAAZA_PLUS_VERSION, 'all' );
        }
...
TaazaPlusSiteLoaderOne::instance();