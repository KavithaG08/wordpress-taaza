...
if( !class_exists( 'TaazaPlusSiteCustomLoader' ) ) {
    class TaazaPlusSiteCustomLoader {
        ...
        function add_option( $options ) {
            $options['custom-loader'] = esc_html__('Custom Loader', 'taaza-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', TAAZA_PLUS_DIR_URL . 'modules/site-loader/layouts/custom-loader/assets/css/custom-loader.css', false, TAAZA_PLUS_VERSION, 'all' );
        }
...
TaazaPlusSiteCustomLoader::instance();