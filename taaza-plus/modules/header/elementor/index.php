...
if( !class_exists( 'TaazaPlusHeaderElementor' ) ) {
    class TaazaPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'taaza_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'taaza_plus_header_content', $content );
		}
    }
}

TaazaPlusHeaderElementor::instance();