...
if( !class_exists( 'TaazaPlusSidebar' ) ) {
    class TaazaPlusSidebar {
        ...
        function load_modules() {
            include_once TAAZA_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('taaza_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('taaza_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
