...
if( !class_exists( 'TaazaPlusLogoWidget' ) ) {
    class TaazaPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require TAAZA_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                TAAZA_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), TAAZA_PLUS_VERSION );
        }
