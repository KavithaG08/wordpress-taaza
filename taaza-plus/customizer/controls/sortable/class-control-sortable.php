...
class Taaza_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'taaza-plus-sortable-control', TAAZA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-sortable-control',  TAAZA_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, TAAZA_PLUS_VERSION );
	}
