...
class Taaza_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'taaza-plus-fontawesome-control', TAAZA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-fontawesome-control',  TAAZA_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, TAAZA_PLUS_VERSION );

		wp_enqueue_style( 'taaza-plus-fontawesome',  TAAZA_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),TAAZA_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "taaza-plus") .' '.esc_html( $this->label );
