...
class Taaza_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'taaza-plus-responsive-spacing-control', TAAZA_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-responsive-spacing-control',  TAAZA_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, TAAZA_PLUS_VERSION );
	}
