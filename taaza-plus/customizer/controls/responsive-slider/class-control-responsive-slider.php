...
class Taaza_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'taaza-plus-responsive-slider-control', TAAZA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-responsive-slider-control',  TAAZA_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, TAAZA_PLUS_VERSION );
	}
