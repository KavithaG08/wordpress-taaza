...
class Taaza_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'taaza-plus-radio-image-control', TAAZA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-radio-image-control',  TAAZA_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, TAAZA_PLUS_VERSION );
	}
