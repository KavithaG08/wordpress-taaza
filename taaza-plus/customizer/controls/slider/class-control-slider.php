...
class Taaza_Customize_Control_Slider extends WP_Customize_Control {
	...
	*/
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'taaza-plus-slider-control', TAAZA_PLUS_DIR_URL.'customizer/controls/slider/slider.js', array( 'jquery', 'customize-base' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-slider-control',  TAAZA_PLUS_DIR_URL.'customizer/controls/slider/slider.css', null, TAAZA_PLUS_VERSION );
	}
