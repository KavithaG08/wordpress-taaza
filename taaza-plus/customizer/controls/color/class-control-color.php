...
class Taaza_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'taaza-plus-color-control', TAAZA_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'taaza-plus-customizer-color-picker' ), TAAZA_PLUS_VERSION, true );
		wp_enqueue_style( 'taaza-plus-color-control',  TAAZA_PLUS_DIR_URL.'customizer/controls/color/color.css', null, TAAZA_PLUS_VERSION );
	}
