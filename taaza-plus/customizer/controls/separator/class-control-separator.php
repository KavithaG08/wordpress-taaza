...
class Taaza_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'taaza-plus-separator-control',  TAAZA_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, TAAZA_PLUS_VERSION );
	}
