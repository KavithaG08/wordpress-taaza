;(function ( $, window, document, undefined ) {
    'use strict';
    $.TAAZAPLUSWPCUSTOMIZER = $.TAAZAPLUSWPCUSTOMIZER || {};

	$.TAAZAPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.TAAZAPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.TAAZAPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').TAAZAPLUSWPCUSTOMIZER_DEPENDENCY();
	});
