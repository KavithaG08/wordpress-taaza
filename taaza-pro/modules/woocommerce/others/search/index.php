...
if( !class_exists( 'Taaza_Shop_Others_Search' ) ) {

    class Taaza_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'taaza-pro')
                    )
                );
...
if( !function_exists('taaza_shop_others_search') ) {
	function taaza_shop_others_search() {
        $reflection = new ReflectionClass('Taaza_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Taaza_Shop_Others_Search::instance();