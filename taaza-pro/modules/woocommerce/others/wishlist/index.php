...
if( !class_exists( 'Taaza_Shop_Others_Wishlist' ) ) {

    class Taaza_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('taaza_shop_others_wishlist') ) {
	function taaza_shop_others_wishlist() {
        $reflection = new ReflectionClass('Taaza_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Taaza_Shop_Others_Wishlist::instance();