...
if( !class_exists( 'Taaza_Shop_Others_Recently_Viewed_Products_Include' ) ) {

    class Taaza_Shop_Others_Recently_Viewed_Products_Include {
        ...
        function __construct() {
			...
			add_action( 'taaza_hook_bottom', array( $this, 'taaza_shop_recently_viewed_products_content' ) );
			add_action( 'wp', array( $this, 'taaza_shop_set_recently_viewed_products' ) );
         ...
         */
			function taaza_shop_recently_viewed_products_content() {
							...
							echo '<div class="wdt-shop-recently-viewed-products-holder">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
									...
									echo '<div class="wdt-shop-recently-viewed-products-title">';
										echo esc_html__('Recently Viewed', 'taaza-pro');
									echo '</div>';
												...
												echo '<div class="wdt-shop-recently-viewed-product swiper-slide">';
													...
													echo '<div class="wdt-shop-recently-viewed-product-info">';
														...
														if( !empty($add_to_cart) ) {
															...
															echo '<div class="wcct_btn_wrapper wc_btn_inline" data-tooltip="'.esc_attr__('Add To Cart', 'taaza-pro' ).'">'.taaza_html_output($add_to_cart).'</div>';
						...
						echo '<div class="wdt-shop-recently-viewed-products-holder">';
							...
							echo '<div class="wdt-shop-recently-viewed-products-wrapper">';
								...
								echo '<div class="wdt-shop-recently-viewed-products-container">';
									echo esc_html__('Sorry, there are no products.', 'taaza-pro');
								echo '</div>';
         ...
         */
			function taaza_shop_set_recently_viewed_products() {
				if(is_product()) {
...
if( !function_exists('taaza_shop_others_recently_viewed_products_include') ) {
	function taaza_shop_others_recently_viewed_products_include() {
        $reflection = new ReflectionClass('Taaza_Shop_Others_Recently_Viewed_Products_Include');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Taaza_Shop_Others_Recently_Viewed_Products_Include::instance();