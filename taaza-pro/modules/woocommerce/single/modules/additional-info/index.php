...
if( !class_exists( 'Taaza_Shop_Single_Module_Additional_Info' ) ) {

    class Taaza_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('taaza_shop_single_module_additional_info') ) {
	function taaza_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Taaza_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Taaza_Shop_Single_Module_Custom_template' ) ) {
    Taaza_Shop_Single_Module_Additional_Info::instance();
}