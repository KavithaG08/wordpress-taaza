...
if( ! function_exists( 'taaza_shop_woo_product_single_custom_template_option' ) ) {
	...
	function taaza_shop_woo_product_single_custom_template_option() {
...
if( ! function_exists( 'taaza_shop_woo_product_single_template' ) ) {

	function taaza_shop_woo_product_single_template( $single_template ) {

		if (is_singular( 'product' )) {

			$product_template = taaza_shop_woo_product_single_custom_template_option();

			if( $product_template == 'custom-template' ) {
				$single_template = taaza_shop_single_module_custom_template()->module_dir_path() . 'templates/custom-template.php';
			}
	...
	add_filter('template_include', 'taaza_shop_woo_product_single_template', 100);
