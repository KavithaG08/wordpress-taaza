...
if( ! function_exists( 'taaza_shop_woo_additional_product_tabs' ) ) {

	function taaza_shop_woo_additional_product_tabs( $tabs ) {
		...
		if( is_array( $product_additional_tabs ) && !empty( $product_additional_tabs ) ) {
			...
			foreach( $product_additional_tabs as $product_additional_tab_key => $product_additional_tab ) {
				...
				$tab_key = 'taaza_'.strtolower($tab_key);

				$tabs[$tab_key] = array(
					'title' 	=> $tab_title,
					'priority' 	=> $priority,
					'callback' 	=> 'taaza_shop_woo_additional_product_tabs_content'
				);
	...
	function taaza_shop_woo_additional_product_tabs_content( $key ) {
	...
	add_filter( 'woocommerce_product_tabs', 'taaza_shop_woo_additional_product_tabs', 10 );
