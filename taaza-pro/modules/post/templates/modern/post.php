<?php
    ...
    <?php
    taaza_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
    if( $template_args['enable_title'] ) :
        taaza_template_part( 'post', 'templates/post-extra/title', '', $template_args );
    endif;

    taaza_template_part( 'post', 'templates/'.$Post_Style.'/parts/author_bio', '', $template_args );

    taaza_template_part( 'post', 'templates/post-extra/content', '', $template_args );
    ?>
