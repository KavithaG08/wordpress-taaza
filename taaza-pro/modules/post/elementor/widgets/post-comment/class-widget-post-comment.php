...
class Elementor_Post_Comments extends TaazaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Comments', 'taaza-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-comments-wrapper '.$style.' '.$el_class.'">';
            $out .= taaza_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/comment', '', $template_args );
		$out .= '</div>';
