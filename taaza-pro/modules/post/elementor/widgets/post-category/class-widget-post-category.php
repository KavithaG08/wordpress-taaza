...
class Elementor_Post_Categories extends TaazaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Categories', 'taaza-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-categories-wrapper '.$style.' '.$el_class.'">';
            $out .= taaza_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
		$out .= '</div>';
