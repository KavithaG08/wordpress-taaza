...
class Elementor_Post_Socials extends TaazaElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Socials', 'taaza-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-social-share-wrapper '.$style.' '.$el_class.'">';
			$out .= taaza_get_template_part( 'post', 'templates/post-extra/social', '', $template_args );
		$out .= '</div>';
