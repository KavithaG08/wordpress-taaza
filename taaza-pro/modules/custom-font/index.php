...
if( !class_exists( 'TaazaProCustomFont' ) ) {
    class TaazaProCustomFont {
        ...
        function load_modules() {
            include_once TAAZA_PRO_DIR_PATH.'modules/custom-font/taxonomy/index.php';
        }

        function load_customizer(){
            add_filter( 'taaza_customizer_custom_fonts', array( $this, 'fonts_list' ), 20 );
        }
        ...
        function elementor_group( $font_groups ) {
            ...
            if( count( $fonts ) > 0 ) {
                $new_group[ 'taaza_custom_fonts' ] = esc_html__( 'Custom Font', 'taaza-pro' );
        ...
        function load_frontend() {
            add_filter( 'taaza_add_inline_style', array( $this, 'custom_font_style' ) );
        }
        ...
        function get_fonts() {
            ...
            $fonts = array();
            $terms = get_terms( 'taaza_custom_fonts', array( 'hide_empty' => false ) );
        ...
        function get_font_links( $id ) {
            $meta = get_term_meta( $id, '_taaza_custom_font_options', true );
