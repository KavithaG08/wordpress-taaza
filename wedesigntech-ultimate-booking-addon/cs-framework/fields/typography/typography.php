...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_html__( 'Web Safe Fonts', 'wdt-ultimate-booking' ) .'">';
      ...
      echo '<optgroup label="'. esc_html__( 'Google Fonts', 'wdt-ultimate-booking' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'wdt-ultimate-booking' );
