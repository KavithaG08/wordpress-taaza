...
class CSFramework_Option_upload extends CSFramework_Options {
  ...
  public function output() {
    ...
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_html__( 'Upload', 'wdt-ultimate-booking' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_html__( 'Use Image', 'wdt-ultimate-booking' );
