(function ($) {
    ...
    const dtColumnWidgetHandler = function($scope, $) {
        ...
        function doLayout() {
            var $column_width = $scope.find('.dt-column-wrapper .dt-column').width();

            var $widget_module_id = $scopeColumn.attr('id');
            
            // script for pagination button
            $('.dt-snap-scroll-pagination .dt-pagination-prev.'+$widget_module_id+'').click(function() {
            ...
            $('.dt-snap-scroll-pagination .dt-pagination-next.'+$widget_module_id+'').click(function() {
                document.getElementById($widget_module_id).scrollBy({
                    left: $column_width,
                    behavior: 'smooth'
                });
	...
	$(window).on('elementor/frontend/init', function () {
		...
		elementorFrontend.hooks.addAction('frontend/element_ready/dt-room-item.default', dtCarouselWidgetHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/dt-room-item.default', dtColumnWidgetHandler);
		elementorFrontend.hooks.addAction('frontend/element_ready/dt-room-list.default', dtCarouselWidgetHandler);
        elementorFrontend.hooks.addAction('frontend/element_ready/dt-room-list.default', dtColumnWidgetHandler);
