...
if( !class_exists( 'Taaza_Woo_Listing_Tag' ) ) {

    class Taaza_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'taaza_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('taaza_woo_listing_tag') ) {
	function taaza_woo_listing_tag() {
		return Taaza_Woo_Listing_Tag::instance();
	}
}

taaza_woo_listing_tag();