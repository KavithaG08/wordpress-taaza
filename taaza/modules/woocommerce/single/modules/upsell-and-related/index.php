...
if( !class_exists( 'Taaza_Shop_Single_Module_Upsell_Related' ) ) {

    class Taaza_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'taaza_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('taaza_shop_single_module_upsell_related') ) {
	function taaza_shop_single_module_upsell_related() {
		return Taaza_Shop_Single_Module_Upsell_Related::instance();
	}
}

taaza_shop_single_module_upsell_related();