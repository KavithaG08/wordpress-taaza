...
if( !class_exists( 'Taaza_Woo_Single_core' ) ) {

    class Taaza_Woo_Single_core {
        ...
        function __construct() {
            ...
            // Enqueue CSS
                add_action( 'taaza_after_woo_css', array ( $this, 'after_woo_css' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/single/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/single/';
                } else {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'taaza_woo_single_page_settings', $this->settings );
        ...
        */
            function load_modules() {
                ...
                include_once TAAZA_MODULE_DIR. '/woocommerce/single/includes/template.php';
                include_once TAAZA_MODULE_DIR. '/woocommerce/single/includes/labels.php';
            ...
            function load_custom_modules() {
                ...
                if( is_array( $custom_modules ) && !empty( $custom_modules ) ) {
                    foreach( $custom_modules as $custom_module ) {
                        ...
                        if( $file_path = taaza_woo_locate_file( $custom_module ) ) {
        ...
        */
            function after_woo_css() {
                ...
                if( is_product() ) {
                    wp_enqueue_style('taaza-woo-single-common', $this->module_dir_url() . 'assets/css/common.css');
                }
...
if( !function_exists('taaza_woo_single_core') ) {
	function taaza_woo_single_core() {
        $reflection = new ReflectionClass('Taaza_Woo_Single_core');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Taaza_Woo_Single_core::instance();