...
if( !class_exists( 'Taaza_Woo_Listing_Shop' ) ) {

    class Taaza_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'taaza_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('taaza_woo_listing_shop') ) {
	function taaza_woo_listing_shop() {
		return Taaza_Woo_Listing_Shop::instance();
	}
}

taaza_woo_listing_shop();