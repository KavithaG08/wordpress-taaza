...
if( !class_exists( 'Taaza_Shop_Others_Quantity_Plus_Minus' ) ) {

    class Taaza_Shop_Others_Quantity_Plus_Minus {
        ...
        function __construct() {
            ...
            // JS
                add_action( 'taaza_after_woo_js', array ( $this, 'after_woo_js' ) );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_DIR . '/woocommerce/others/quantity-plus-minus/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( taaza_is_file_in_theme( __FILE__ ) ) {
                    return TAAZA_MODULE_URI . '/woocommerce/others/quantity-plus-minus/';
                } else {
        ...
        */
            function after_woo_js() {
                ...
                if( !is_product() && !is_cart() ) {
                    ...
                    wp_register_script( 'taaza-woo-quantity-plus-minus', '', array ('jquery'), false, true );
                    wp_enqueue_script( 'taaza-woo-quantity-plus-minus' );
                    ...
                    if( !empty($js) ) {
                        wp_add_inline_script( 'taaza-woo-quantity-plus-minus', $js );
                    }
...
if( !function_exists('taaza_shop_others_quantity_plus_minus') ) {
	function taaza_shop_others_quantity_plus_minus() {
        $reflection = new ReflectionClass('Taaza_Shop_Others_Quantity_Plus_Minus');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Taaza_Shop_Others_Quantity_Plus_Minus::instance();