...
if( !class_exists( 'Taaza_Woo_Others' ) ) {

    class Taaza_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'taaza_woo_others_settings', $this->settings );
...
if( !function_exists('taaza_woo_others') ) {
	function taaza_woo_others() {
		return Taaza_Woo_Others::instance();
	}
}
