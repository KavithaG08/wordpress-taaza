		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'template', array(
				...
				'options' => array(
					...
					'icon-aside' => esc_html__( 'Icon Aside', 'wdt-elementor-addon' ),
					'image-aside' => esc_html__( 'Image Aside', 'wdt-elementor-addon' ),
					'image-with-count' => esc_html__( 'Image with Count', 'wdt-elementor-addon' ),
					'image-with-content' => esc_html__( 'Image with Content', 'wdt-elementor-addon' ),
					'fake-insta' => esc_html__( 'Fake Instagram', 'wdt-elementor-addon' ),
		...
		$this->cc_style->get_style_controls($elementor_object, array (
			...
			'styles' => array (
				'media_image_type' => array (
					...
					'condition' => array (
						'template' => array ('default', 'custom-template', 'with-description', 'classic', 'image-with-count', 'icon-aside', 'image-with-content', 'fake-insta')
					)
				),
				'alignment' => array (
					'field_type' => 'alignment',
	...
	public function render_html($widget_object, $settings) {
		...
		if( count( $settings['item_contents'] ) > 0 ):
			...
			$output .= $this->cc_layout->get_wrapper_start();
				...
				} else if($settings['template'] == 'image-with-count') {
				...
				} else if($settings['template'] == 'fake-insta') {
				...
				} else if($settings['template'] == 'image-with-content') {
				...
				} else if($settings['template'] == 'icon-aside') {
				...
				} else if($settings['template'] == 'image-aside') {
